...
/** @typedef {import('../index').ElementSelector} ElementSelector */

/**
 * 
 * @param {number} inViewDistance 
 */
export default  function eventHandlers(inViewDistance) {
        ...
        /**
         * 
         * @param {ElementSelector[] | ElementSelector} elementsToAnimate 
         * @returns {() => void}
         */
        ...
        /**
         * 
         * @param {ElementSelector[] | ElementSelector} elementSelectors 
         * @returns {void}
         */
